...
function DriverNearByDropOff({setNearByDropOff}) {
    const timerRef = useRef(null)
    useEffect(()=>{
     timerRef.current =  setTimeout(()=>{
        setNearByDropOff(false)
      },5000)
      return ()=>{
...
>
  <div className='flex items-center justify-between'>
    <div>
      <h1 className='text-xl font-bold text-white'>Approaching DropOff</h1>
      <p className='text-md text-gray-200'>1.2 kilometres away | ETA: 2 mins</p>
    </div>
