...
function BookingInfo() {
  const { tripDetail, message ,tripStatus} = useSelector((state) => state.trip);
  ...
  return (
    ...
    //       </>
    //     )}
    //     {(tripStatus == "accepted" || tripStatus == "started")   &&  <div class="flex justify-center items-center ">
    //       <button
    ...
    //   { tripStatus == "accepted" || tripStatus == "requested" && <button
